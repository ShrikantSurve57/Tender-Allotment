...
<html lang="en">
  <head>
    ...
    <title>Tender Allotment System</title>
              ...
              <!-- Developer 1 Mr. Shashi Raj-->
                <div class="col-md-3 col-xs-12 col-sm-3" >
                  <div class="col-md-5 col-xs-5 col-sm-5">
                    <img src="images/shrikantsurve.jpg" class="img-responsive img-circle pull-right" style="width:100px;height:105px;"alt="Shrikant Surve Developer" title="Shrikant Surve"/>
                  </div>
                  <div class="col-md-7 col-xs-7 col-sm-7">
                    <div class="developers pull-left" style="font-weight: bold; color:white;text-align: center;">
                    <br/>
                    <span style="font-size: 1.7em; color:rgb(255, 255, 255)">Shrikant Surve</span>
<!--                     <p><span>Web Developer</span></p>
 -->                    <p>SIOM MCA II</p>
  ...
  <div class="navbar-inverse" style="color:white;padding:05px;margin-bottom:-17px;text-align: center;background-color:green; border-radius: 0px">
                      <span style="float:left;padding-left: 6.5%">&copy;Sinhgad Institute Of Management Copyright 2025</span><span style="padding-left:5%;">&nbsp; Tender Allotment Portal</span><span style="float:right;padding-right: 6%" class="hidden-xs">&nbsp;...THANKS FOR VISITING...</span>
</div><br/>
